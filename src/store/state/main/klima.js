...
export const klima = {
  ...
  content: [
    ...
    },
    {
      tag:"table",
      value: [
        {service:"Pakiet podstawowy (cena zawiera 150g czynnika R-134a)", price: "100,00 zł"},
        {service:"Pakiet zaawansowany (cena zawiera 150g czynnika R-134a)", price:"130,00 zł"},
        {service:"Naprawa układu klimatyzacji", price:"od 50,00 zł"},
        {service:"Dezynfekcja układu", price:"od 50,00 zł"},
        {service:"Wymiana filtra kabinowego", price:"od 10,00 zł"}
      ]
    },
    {
      tag:"img",
